class nest (
  ...
  $console_font_size_ideal   = 14 * $::nest::text_scaling_factor
  $console_font_size_smaller = inline_template('<%= @console_font_sizes.reverse.find(14) { |size| size - @console_font_size_ideal.round <= 0 } %>')
